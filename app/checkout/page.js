...
export default function CheckoutPage() {
    ...
    const handlePotvrda = async (e) => {
        ...
        const res = await kreirajPorudzbinu(total, cartItems);
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <form onSubmit={handlePotvrda} className="space-y-6">
                        <div className="border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] bg-white">
                            ...
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <input
                                        type="text" name="ime_prezime" required onChange={handleInputChange}
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text" name="adresa" required onChange={handleInputChange}
                                        className="w-full border-2 border-black p-3 font-bold uppercase text-xs focus:bg-zinc-50 outline-none transition-all"
                                    />
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            type="text" name="grad" required onChange={handleInputChange}
                                            className="w-full border-2 border-black p-3 font-bold uppercase text-xs focus:bg-zinc-50 outline-none transition-all"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            type="text" name="postanski_broj" required onChange={handleInputChange}
                                            className="w-full border-2 border-black p-3 font-bold uppercase text-xs focus:bg-zinc-50 outline-none transition-all"
                                        />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text" name="kontakt_telefon" required onChange={handleInputChange}
                                        className="w-full border-2 border-black p-3 font-bold uppercase text-xs focus:bg-zinc-50 outline-none transition-all"
                                    />
                                </div>
                            </div>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-6 bg-[var(--color-druze-roze)] font-black uppercase tracking-widest border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all active:bg-black active:text-white"
                        >
